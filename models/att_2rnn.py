from models.attention_layers.vanilla_attention import VanillaAttentionNetwork
...
class Att2RNN():
    ...
    def __init__(self, metadata, word_embd, word_embd_dim=None,word_embd_matrix_google=None, word_embd_matrix_train200=None,
                ...
                attention_dim = None, optimizer = None, optimizer_algorithm = None):
    ...
    def create_model(self,):
        ...
        van_att = VanillaAttentionNetwork(self.attention_dim)(utterance_bigru)

        model1 = Model(inputs=input_shape, outputs=van_att)
